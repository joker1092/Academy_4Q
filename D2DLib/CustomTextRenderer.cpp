...
CustomTextRenderer::~CustomTextRenderer()
{
    Memory::SafeDelete(pD2DFactory_);
    Memory::SafeDelete(pRT_);
    Memory::SafeDelete(pOutlineBrush_);
    //Memory::SafeDelete(pFillBrush_);
}
...
)
{
    ...
    Memory::SafeDelete(pPathGeometry);
    Memory::SafeDelete(pSink);
    Memory::SafeDelete(pTransformedGeometry);
...
)
{
    ...
    Memory::SafeDelete(pRectangleGeometry);
    Memory::SafeDelete(pTransformedGeometry);
